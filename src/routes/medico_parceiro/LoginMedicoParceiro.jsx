...
const LoginMedicoParceiro = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const usuario = { username: username, password };
            ...
            if (result.success) {
                ...
                if (result.error?.status === 401) {
                    msg = 'Falha no login. Credenciais incorretas'
                } else {
                    msg = result.error?.message || result.error || 'Falha no login. Verifique suas credenciais.';
                }
                setError(msg);
...
export default LoginMedicoParceiro;